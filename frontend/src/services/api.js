...
export const analyticsAPI = {
  ...
  getOrganizerDashboard: async () => {
    return apiCall('/analytics/organizer/dashboard', {
      method: 'GET',
    });
  },

  getOrganizerRevenue: async (startDate, endDate, interval = 'day') => {
    const params = new URLSearchParams({
      start_date: startDate,
      end_date: endDate,
      interval
    });
    return apiCall(`/analytics/organizer/revenue?${params.toString()}`, {
      method: 'GET',
    });
  },

  getOrganizerFormats: async () => {
    return apiCall('/analytics/organizer/formats', {
      method: 'GET',
    });
  },

  getOrganizerTournaments: async (limit = 10, offset = 0) => {
    const params = new URLSearchParams({ limit, offset });
    return apiCall(`/analytics/organizer/tournaments?${params.toString()}`, {
      method: 'GET',
    });
  },
  ...
  getPlayerDashboard: async () => {
    return apiCall('/analytics/player/dashboard', {
      method: 'GET',
    });
  },

  getPlayerPerformance: async (startDate, endDate) => {
    const params = new URLSearchParams({
      start_date: startDate,
      end_date: endDate
    });
    return apiCall(`/analytics/player/performance?${params.toString()}`, {
      method: 'GET',
    });
  },

  getPlayerMatches: async (limit = 10, offset = 0) => {
    const params = new URLSearchParams({ limit, offset });
    return apiCall(`/analytics/player/matches?${params.toString()}`, {
      method: 'GET',
    });
  },
  ...
  getAdminDashboard: async () => {
    return apiCall('/analytics/admin/dashboard', {
      method: 'GET',
    });
  },

  getAdminGrowth: async (interval = 'day') => {
    const params = new URLSearchParams({ interval });
    return apiCall(`/analytics/admin/growth?${params.toString()}`, {
      method: 'GET',
    });
  },

  getTopOrganizers: async (limit = 10) => {
    const params = new URLSearchParams({ limit });
    return apiCall(`/analytics/admin/top-organizers?${params.toString()}`, {
      method: 'GET',
    });
  },
  ...
  getTopPlayers: async (limit = 10) => {
    const params = new URLSearchParams({ limit });
    return apiCall(`/analytics/admin/top-players?${params.toString()}`, {
      method: 'GET',
    });
  },
};
